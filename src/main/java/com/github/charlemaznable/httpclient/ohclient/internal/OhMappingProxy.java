    ...
    static class Elf {
        ...
        static void setUpBeforeInitialization(Configurer configurer, Method method, Class clazz, OhProxy proxy) {
            if (configurer instanceof InitializationConfigurer) {
                ((InitializationConfigurer) configurer).setUpBeforeInitialization(clazz, method);
            } else if (proxy.configurer instanceof InitializationConfigurer) {
                ((InitializationConfigurer) proxy.configurer).setUpBeforeInitialization(clazz, method);
            } else {
        ...
        static void tearDownAfterInitialization(Configurer configurer, Method method, Class clazz, OhProxy proxy) {
            if (configurer instanceof InitializationConfigurer) {
                ((InitializationConfigurer) configurer).tearDownAfterInitialization(clazz, method);
            } else if (proxy.configurer instanceof InitializationConfigurer) {
                ((InitializationConfigurer) proxy.configurer).tearDownAfterInitialization(clazz, method);
            } else {
